...
namespace MyProject.UI
{
    public partial class CreateContractForm : Form
    {
        ...
        private void btnCreate_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Anna sopimuksen nimi!", "Virhe", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
            ...
            if (newContractId > 0)
            {
                MessageBox.Show("Sopimus luotu onnistuneesti!", "OK", MessageBoxButtons.OK, MessageBoxIcon.Information);
                txtContractName.Clear();
            }
            else
            {
                MessageBox.Show("Sopimuksen luonti epäonnistui!", "Virhe", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
