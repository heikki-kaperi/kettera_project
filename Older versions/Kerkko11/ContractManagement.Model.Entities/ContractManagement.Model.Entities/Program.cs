    ...
    public class InternalUserSession : UserSession
    {
        ...
        private void BlockManagementMenu()
        {
            while (true)
            {
                ...
                Console.WriteLine("7. Modify Existing Block");
                Console.WriteLine("8. Add Reference to Block");
                Console.WriteLine("9. Create Composite Block");
                ...
                switch (Console.ReadLine())
                {
                    ...
                    case "7": ModifyExistingBlock(); break;
                    case "8": AddReferenceToBlockUI(); break;
                    case "9": CreateCompositeBlockUI(); break;
        ...
        private void ModifyExistingBlock()
        {
            ViewAllOriginalBlocks();
            Console.Write("\nEnter Original Block ID to modify: ");
            ...
            var block = _blockController.GetAllOriginalBlocks().FirstOrDefault(b => b.Org_Cont_ID == blockId);
            if (block == null)
            {
                Console.WriteLine("\n✗ Block not found.");
                Pause();
            ...
            Console.WriteLine($"\nCurrent text: {block.Contract_text}");
            Console.Write("\nEnter new text (or press Enter to keep current): ");
            ...
            bool success = _blockController.UpdateOriginalBlock(block);
